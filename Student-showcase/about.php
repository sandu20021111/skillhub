...
<body>
    ...
    <section class="about">
        <div class="main">
            <img src="assets/img/about.jpg" alt="Professional Businessman Working">
            <div class="about-text">
                <h1>About Us</h1>
                <h5>Developer <span>& Designer</span></h5>
                <p>
                    Welcome to our Student Projects Showcase Hub! We are a passionate team of undergraduates from CINEC, dedicated to building a space where students can share their innovative projects, academic work, and research with the world. Our platform aims to highlight student talent, encourage collaboration, and inspire creativity through open access to peer achievements. Join us as we celebrate ideas that shape the future!
                </p>
                <a href="contact.php">
